/**
 * This is a document implementation with automege.
 * Automerge enables collaborative editing of documents.
 * The automerge library is quite large though, so until we support it we will use a more basic
 * implementation found in document.ts
 */
